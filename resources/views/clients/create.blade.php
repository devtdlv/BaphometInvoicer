...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
    <h1 style="font-size: 2rem; font-weight: 700;">Add Client</h1>
...
<form method="POST" action="{{ route('clients.store') }}">
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address_line_1" class="form-input" value="{{ old('address_line_1') }}">
        </div>
        
        <div class="form-group">
            <label class="form-label">Address Line 2</label>
            <input type="text" name="address_line_2" class="form-input" value="{{ old('address_line_2') }}">
        </div>
